        ...
        <div class="row justify-content-center">
          <div class="col-md-10">
            <div class="card card-primary">
              ...
              <form @submit.prevent="updateContent" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
 ...
 mounted() {
  ...
  created() {
      axios.get('/contentById/'+this.$route.params.contentId).then((Response)=>{
          ...
          this.getSubCategory();
        //   this.form.fill(Response.data.contentById)
  ...
  methods: {
    ...
    updateContent () {
      ...
      axios.post(`/contentUpdate/${this.$route.params.contentId}`,form).then(({ data }) => {
